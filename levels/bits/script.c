...
const LevelScript level_bits_entry[] = {
    ...
    AREA(/*index*/ 1, bits_geo_000718),
        ...
        OBJECT(/*model*/ MODEL_CHEESE_FOLLOW, /*pos*/ -6839, -3812,     4, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvCheeseFollow),
        ...
        SET_BACKGROUND_MUSIC(/*settingsPreset*/ 0x0000, /*seq*/ SEQ_LEVEL_BOSS_KOOPA_FINAL),
