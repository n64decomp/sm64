...
static const LevelScript script_func_local_4[] = {
    ...
    OBJECT(/*model*/ MODEL_MARK,     /*pos*/     0, 3174, -5625, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvMark),
    RETURN(),
};
...
const LevelScript level_castle_grounds_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_MARINE_ED,                   marine_ed_geo),
    LOAD_MODEL_FROM_GEO(MODEL_MIPS_ED,                     mips_ed_geo),
