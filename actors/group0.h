...
extern const Gfx mario_shadow_butt[];
...
extern const Gfx mario_shadow_right_hand_closed[];
...
extern const Gfx mario_shadow_left_thigh[];
...
extern const Gfx mario_shadow_right_foot[];
...
extern const Gfx mario_shadow_torso[];
